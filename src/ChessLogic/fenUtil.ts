...
export function getCastlingAvailability(castleState: {
  ...
  let castling = "";
  if (!castleState.white.kingSideCastle) castling += "K";
  if (!castleState.white.queenSideCastle) castling += "Q";
  if (!castleState.black.kingSideCastle) castling += "k";
  if (!castleState.black.queenSideCastle) castling += "q";
